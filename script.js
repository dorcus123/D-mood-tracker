document.getElementById("submit-btn").addEventListener("click", function () {
    ...
    switch (mood) {
        case "happy":
            message = "Favor every second of this happiness, allowing it to spread. You are on a path of positivity and growth, keep moving forward!";
            break;
        case "sad":
        ...
        case "anxious":
            ...
            break;
        case "excited":
            message = "Embrace your enthusiasm and allow it to fuel your dreams. God is giving you a reason to smile! This energy will lead you far on your path!";
            break;
        default:
